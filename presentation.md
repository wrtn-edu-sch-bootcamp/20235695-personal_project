...
| # | 기능 | 설명 |
|---|------|------|
| 1 | 📄 재고서 업로드 | 사진(OCR) 또는 CSV 파일 |
| 2 | 📱 바코드 스캔 | 스마트폰 카메라로 실시간 인식 |
| 3 | 🔢 수량 입력 | 바코드 스캔 후 실물 수량 기록 |
| 4 | ⚡ 자동 대조 | 재고서 vs 실물 수량 자동 비교 |
...
│  /upload (재고서 업로드)   /api/reports (리포트)     │
...
- 사용자: "콜라 몇 개 있어?"
- AI: "코카콜라 500ml은 재고서 24개, 실물 확인 22개로 2개 부족합니다."
